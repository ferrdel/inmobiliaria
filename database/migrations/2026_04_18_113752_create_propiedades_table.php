...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('propiedades', function (Blueprint $table) {
            ...
            $table->text('direccion');       // Dirección completa
            $table->decimal('precio', 15, 2); // Valor monetario (soporta millones)
            ...
            // crea una relación: una propiedad pertenece a un usuario (operador o admin)
